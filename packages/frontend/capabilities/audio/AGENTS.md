# frontend-capability-audio

## Responsibility

AUDIO renderer and interaction plugin boundary.
...
Run `pnpm verify:module frontend-capability-audio` after the command is available.
