# frontend-capability-image

## Responsibility

IMAGE renderer and interaction plugin boundary.
...
Run `pnpm verify:module frontend-capability-image` after the command is available.
