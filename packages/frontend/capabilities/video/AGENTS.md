# frontend-capability-video

## Responsibility

VIDEO renderer and interaction plugin boundary.
...
Run `pnpm verify:module frontend-capability-video` after the command is available.
