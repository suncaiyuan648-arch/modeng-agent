# frontend-guided-skill

## Responsibility

Trusted guided-skill controls and accessible form interaction.
...
Run `pnpm verify:module frontend-guided-skill` after the command is available.
