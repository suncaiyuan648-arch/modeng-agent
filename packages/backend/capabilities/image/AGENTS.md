# backend-capability-image

## Responsibility

IMAGE handler plugin composed through backend public ports.
...
Run `pnpm verify:module backend-capability-image` after the command is available.
