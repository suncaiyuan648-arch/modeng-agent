# backend-capability-talk

## Responsibility

TALK handler plugin composed through backend public ports.
...
Run `pnpm verify:module backend-capability-talk` after the command is available.
