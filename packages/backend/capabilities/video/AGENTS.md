# backend-capability-video

## Responsibility

VIDEO handler plugin composed through backend public ports.
...
Run `pnpm verify:module backend-capability-video` after the command is available.
