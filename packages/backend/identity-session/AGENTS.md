# backend-identity-session

## Responsibility

Identity, authentication and device-session ownership.
...
Run `pnpm verify:module backend-identity-session` after the command is available.
