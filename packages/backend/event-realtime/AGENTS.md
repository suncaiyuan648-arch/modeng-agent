# backend-event-realtime

## Responsibility

Event envelope, outbox, replay and realtime delivery ownership.
...
Run `pnpm verify:module backend-event-realtime` after the command is available.
