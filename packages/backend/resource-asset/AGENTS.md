# backend-resource-asset

## Responsibility

Resource, artifact and object-storage lifecycle ownership.
...
Run `pnpm verify:module backend-resource-asset` after the command is available.
