# backend-workspace-conversation

## Responsibility

Workspace, project, conversation and message ownership.
...
Run `pnpm verify:module backend-workspace-conversation` after the command is available.
