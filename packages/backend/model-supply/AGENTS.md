# backend-model-supply

## Responsibility

Model catalog, negotiation, routing and provider execution boundary.
...
Run `pnpm verify:module backend-model-supply` after the command is available.
