...
| `ARCH006` | `PUBLIC_CONTRACT_UNAUTHORIZED_CHANGE` | A frozen Contract changed without a valid Contract Change Proposal.                |
...
| `ARCH011` | `ARCHITECTURE_REVIEW_REQUIRED`        | A manifest or other Yellow-zone architecture file changed without review evidence. |
